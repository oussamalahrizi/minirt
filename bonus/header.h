...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/04 05:46:09 by idelfag           #+#    #+#             */
/*   Updated: 2024/01/04 06:41:55 by olahrizi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				calculate_cone_props(int min_index, t_vec3 *poi,
					t_info *info, t_vec3 *vhat);
t_vec3			specular_highlight(t_vars *vars, t_info *info,
					t_ray *camera_ray);
